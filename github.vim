...
hi Type                 guifg=#445588 ctermfg=60 gui=bold cterm=bold
    hi StorageClass     guifg=#dd1144 ctermfg=161 gui=bold cterm=bold
    hi Structure        guifg=#dd1144 ctermfg=161 gui=bold cterm=bold
    hi Typedef          guifg=#dd1144 ctermfg=161 gui=bold cterm=bold
...
hi Cursor               guifg=NONE ctermfg=NONE guibg=#666666 ctermbg=227
"hi CursorLine           guifg=NONE ctermfg=NONE guibg=#ffffcc ctermbg=230
hi CursorLine           guifg=NONE ctermfg=NONE guibg=#eaeaea ctermbg=230
